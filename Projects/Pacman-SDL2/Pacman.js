...
var ASM_CONSTS = {
 ...
 136672: ($0) => { if (Module['canvas']) { Module['canvas'].style['cursor'] = UTF8ToString($0); } },  
 136755: () => { if (Module['canvas']) { Module['canvas'].style['cursor'] = 'none'; } },  
 136824: () => { return window.innerWidth; },  
